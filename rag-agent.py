...
def start_chat():
    ...
    message = f"""expand the following question to add more relevant questions. think of the 5 most relevant supplementary questions, select the top 1 question and add it to the original question. The original question must be included in the final question. Only return the final question.
    \n
